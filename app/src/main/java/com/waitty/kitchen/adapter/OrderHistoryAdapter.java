...
//                        Date arrivalDate = WaittyConstants.dateFormaterServer.parse(Utility.chageUTC_ToLocalDate(WaittyConstants.dateFormaterServer,data.getOrderArrivingTime().trim(), WaittyConstants.dateFormaterServer));
//                        Date currentDate= WaittyConstants.dateFormaterServer.parse(WaittyConstants.dateFormaterServer.format(Calendar.getInstance().getTime()));
//
...
//            Call<JsonElement> call = apiInterface.orderStartPreparing(jsonObject,Utility.getSharedPreferencesString(mContext, WaittyConstants.USER_SECURITY_TOKEN));
...
//
//            ApiInterface apiInterface = ApiClient.getClient().create(ApiInterface.class);
//            Call<JsonElement> call = apiInterface.doneOrder(jsonObject,Utility.getSharedPreferencesString(mContext, WaittyConstants.USER_SECURITY_TOKEN));
//            new APICall(mContext).Server_Interaction(call, new getResponseData() {
//                @Override
//                public void onSuccess(JSONObject OBJ, String msg, String typeAPI) {
//                    loader.dismiss();
...
//
//            ApiInterface apiInterface = ApiClient.getClient().create(ApiInterface.class);
//            Call<JsonElement> call = apiInterface.setOrderETA(jsonObject,Utility.getSharedPreferencesString(mContext, WaittyConstants.USER_SECURITY_TOKEN));
//            new APICall(mContext).Server_Interaction(call, new getResponseData() {
//                @Override
//                public void onSuccess(JSONObject OBJ, String msg, String typeAPI) {
//                    try{
