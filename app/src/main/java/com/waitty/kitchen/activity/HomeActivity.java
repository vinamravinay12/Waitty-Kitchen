...
//    private void init() {
//        try {
//            Utility.setSharedPreferencesBoolean(this, WaittyConstants.IS_LOGIN, true);
//            Utility.setSharedPreferencesBoolean(mContext, WaittyConstants.NEW_RELOAD_BY_FCM,false);
...
//        update = new Runnable() {
//            public void run() {
//                int totalUnreadNewCount = Utility.getSharedPreferencesInteger(mContext, WaittyConstants.NOTIFICATION_COUNT_NEW);
//                if(totalUnreadNewCount>0)
//                    newBadgeAction(true);
//                else
//                    newBadgeAction(false);
//
//                if(Utility.getSharedPreferencesBoolean(mContext, WaittyConstants.NEW_RELOAD_BY_FCM)){
//                    Utility.setSharedPreferencesBoolean(mContext, WaittyConstants.NEW_RELOAD_BY_FCM,false);
