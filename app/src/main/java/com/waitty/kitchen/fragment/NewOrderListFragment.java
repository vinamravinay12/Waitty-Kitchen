...
//        fragmentNeworderListBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_order_details_new, container, false);
...
//                Utility.setSharedPreferencesInteger(mContext, WaittyConstants.NOTIFICATION_COUNT_NEW,0);
//                ((HomeActivity)mContext).newBadgeAction(false);
...
//            Call<JsonElement> call = apiInterface.getNewOrder(jsonobject,utility.getsharedPreferencesString(mContext, WaittyConstants.USER_SECURITY_TOKEN));
...
//        if(itemList.size()==0)
//            ((HomeActivity)mContext).changeBackgroundColor(0,false);
//        else
//            ((HomeActivity)mContext).changeBackgroundColor(0,true);
//    }
}